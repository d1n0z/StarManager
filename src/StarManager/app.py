...
async def lifespan(app: FastAPI):
    ...
    task = asyncio.create_task(load_messages.load(), name="load_messages")
    app.state.bg_tasks.append((task, None))

    vk_task = asyncio.create_task(vkbot_module.run_bot(), name="vkbot")
