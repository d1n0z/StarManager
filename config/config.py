...
COMMANDS = {
    ...
    "delasync": 7, "filter": 7, "filteradd": 7, "filterdel": 7, "listasync": 7,
    ...
    "statuslist": 8, "cmdcount": 8, "block": 8, "unblock": 8, "getlink": 8, "backup": 8,
    "reboot": 8, "sudo": 8, "givexp": 8, "resetlvl": 8, "getuserchats": 8, "helpdev": 8,
...
COMMANDS_DESC = {
    ...
    "repban": '/repban - Заблокировать репутацию пользователю.',
    "repunban": '/repunban - Разблокировать репутацию пользователю.',
    "repbanlist": '/repbanlist - Список пользователей с заблокированной репутацией.',
