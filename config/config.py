...
COMMANDS_DESC = {
    ...
    "raid": "/raid - Борьба со сливом беседы или массовыми приглашениями участников.",
...
TG_ADMINS = literal_eval(config["TELEGRAM"]["TG_ADMINS"])
...
TG_SCHEDULER_THREAD = config["TELEGRAM"]["TG_SCHEDULER_THREAD"]
TG_REPORTS_CHAT_ID = config["TELEGRAM"]["TG_REPORTS_CHAT_ID"]
TG_REPORTS_NEW_THREAD_ID = config["TELEGRAM"]["TG_REPORTS_NEW_THREAD_ID"]
TG_REPORTS_ARCHIVE_THREAD_ID = config["TELEGRAM"]["TG_REPORTS_ARCHIVE_THREAD_ID"]
