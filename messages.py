...
/lvlbanlist - список забаненных в экосистеме
/lvlban - выдать бан в экосистеме
/lvlunban - снять бан в экосистеме
/helpdev - команды DEV'''
...
def lvlbanned():
    return ('📛 Вы были заблокированы в экосистеме бота. Вы не получаете опыт и Star монеты, а также '
            'не можете пользоваться командами /task, /bonus, /transfer и /duel.')
...
def lvlunban_hint():
    return '🔔 Чтобы разбанить пользователя, используйте /lvlunban @VK. (Пример: /lvlunban @andrey_mala)'


def lvlunban():
    return '✅ Вы успешно разбанили данного пользователя'


def lvlban_hint():
    return '🔔 Чтобы забанить пользователя в экосистеме бота, используйте /lvlban @VK. (Пример: /lvlban @andrey_mala)'


def lvlban():
    return '✅ Вы успешно забанили данного пользователя в экосистеме бота'


def user_lvlbanned():
    return '❌ Данный пользователь был заблокирован в экосистеме бота.'
