...
async def gkick(message: Message):
    ...
    if (len(data) == 1 and message.reply_message is None) or not id:
        return await messagereply(
            message, disable_mentions=1, message=messages.gkick_hint()
        )
    if id < 0:
        return await messagereply(
    ...
    for chat_id in chats:
        ...
        if u_acc <= await getUserAccessLevel(id, chat_id) or not await haveAccess(
            "gkick", chat_id, u_acc
        ):
            continue
...
async def gban(message: Message):
    ...
    if (len(data) == 1 and message.reply_message is None) or not id:
        return await messagereply(
            message, disable_mentions=1, message=messages.gban_hint()
        )
    if id < 0:
        return await messagereply(
            message, disable_mentions=1, message=messages.id_group()
...
async def gunban(message: Message):
    ...
    if (len(data) == 1 and message.reply_message is None) or not id:
        return await messagereply(
            message, disable_mentions=1, message=messages.gunban_hint()
        )
    if id < 0:
        return await messagereply(
            message, disable_mentions=1, message=messages.id_group()
...
async def gmute(message: Message):
    ...
    if (len(data) == 1 and message.reply_message is None) or not id:
        return await messagereply(
            message, disable_mentions=1, message=messages.gmute_hint()
        )
    if id < 0:
        return await messagereply(
            message, disable_mentions=1, message=messages.id_group()
...
async def gunmute(message: Message):
    ...
    if id == uid:
        return await messagereply(
            message, disable_mentions=1, message=messages.unmute_myself()
        )
    if (len(data) == 1 and message.reply_message is None) or not id:
        return await messagereply(
            message, disable_mentions=1, message=messages.gunmute_hint()
        )
    if id < 0:
        return await messagereply(
            message, disable_mentions=1, message=messages.id_group()
    ...
    edit = await messagereply(
        message,
        disable_mentions=1,
        message=messages.gunmute_start(
            uid,
            u_name,
            await getUserNickname(uid, chat_id),
            id,
...
async def gwarn(message: Message):
    ...
    if (len(data) == 1 and message.reply_message is None) or not id:
        return await messagereply(
            message, disable_mentions=1, message=messages.gwarn_hint()
        )
    if id < 0:
        return await messagereply(
            message, disable_mentions=1, message=messages.id_group()
...
async def gunwarn(message: Message):
    ...
    if id == uid:
        return await messagereply(
            message, disable_mentions=1, message=messages.unwarn_myself()
        )
    if (len(data) == 1 and message.reply_message is None) or not id:
        return await messagereply(
            message, disable_mentions=1, message=messages.gunwarn_hint()
        )
    if id < 0:
        return await messagereply(
            message, disable_mentions=1, message=messages.id_group()
    ...
    edit = await messagereply(
        message,
        disable_mentions=1,
        message=messages.gunwarn_start(
            uid,
            u_name,
            await getUserNickname(uid, chat_id),
            id,
...
async def gsnick(message: Message):
    ...
    if (len(data) == 1 and message.reply_message is None) or not id:
        return await messagereply(
            message, disable_mentions=1, message=messages.gsnick_hint()
        )
    if id < 0:
        return await messagereply(
            message, disable_mentions=1, message=messages.id_group()
...
async def grnick(message: Message):
    ...
    if (len(data) == 1 and message.reply_message is None) or not id:
        return await messagereply(
            message, disable_mentions=1, message=messages.grnick_hint()
        )
    if id < 0:
        return await messagereply(
            message, disable_mentions=1, message=messages.id_group()
...
async def gzov(message: Message):
    ...
    if len(data) <= 1:
        return await messagereply(
            message, disable_mentions=1, message=messages.gzov_hint()
        )
